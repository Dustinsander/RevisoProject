...
<!-- Sidebar -->
<div id="sidebar" 
     class="fixed top-15 left-0 h-full w-64 bg-[#A84EEA] text-white transform -translate-x-48 transition-transform duration-300 ease-in-out z-40 flex flex-col">
  ...
  <div class="flex-1 p-4 space-y-4 text-white text-2xl font-semibold">
    ...
    <a href="#" ata-tab="progress" class="block hover:bg-gray-400 p-6 rounded">Settings</a>
