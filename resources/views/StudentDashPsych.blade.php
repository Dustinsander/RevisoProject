...
<body class="bg-gray-200 min-h-screen">
    ...
    <div class="flex">
        ...
        {{-- SIDEBAR --}}
        <aside class="w-64 bg-purple-500 min-h-[calc(100vh-4rem)] text-white">
            <nav class="flex flex-col text-lg font-semibold">
                <a href="#" class="bg-purple-700 px-6 py-5">Dashboard</a>
                <a href="#" class="px-6 py-5 hover:bg-purple-600">Lectures</a>
                <a href="#" class="px-6 py-5 hover:bg-purple-600">Assessments</a>
                <a href="#" class="px-6 py-5 hover:bg-purple-600">Progress Tracker</a>
            </nav>
        </aside>
