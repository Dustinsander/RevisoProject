    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-[#E8D86F] min-h-[calc(100vh-4rem)] text-white">
            <nav class="flex flex-col text-lg font-semibold">
                <a href="#" class="bg-[#D5C34E] px-6 py-5">Dashboard</a>
                <a href="#" class="px-6 py-5 hover:bg-[#D5C34E]">Lectures</a>
                <a href="#" class="px-6 py-5 hover:bg-[#D5C34E]">Assessments</a>
                <a href="#" class="px-6 py-5 hover:bg-[#D5C34E]">Progress Tracker</a>
            </nav>
        </aside>
