...
<body class="bg-gray-200 min-h-screen">
    ...
    <div class="flex">
        ...
        {{-- SIDEBAR --}}
        <aside class="w-64 bg-[#E8D86F] min-h-[calc(100vh-4rem)] text-white">
            <nav class="flex flex-col text-lg font-semibold">
                 <a href="#" data-tab="dashboard" class="bg-[#D5C34E] px-6 py-5">Dashboard</a>
                    <a href="#" data-tab="lectures" class="px-6 py-5 hover:bg-[#D5C34E]">Lectures</a>
                    <a href="#" data-tab="assessments" class="px-6 py-5 hover:bg-[#D5C34E]">Assessments</a>
                    <a href="#" data-tab="progress" class="px-6 py-5 hover:bg-[#D5C34E]">Progress Tracker</a>
            </nav>
        </aside>
        ...
        <section id="dashboard">
            <div class="bg-white rounded-2xl p-8">
                ...
                <p class="text-lg">January 20, 2025 – Quarterly Financial Report</p>
                <p class="text-lg">February 15, 2025 – Tax Filing</p>
                </div>

            {{-- PERFORMANCE TRACKER --}}
            <div class="bg-white rounded-2xl p-8 mt-5">
                <h2 class="text-2xl font-bold mb-6">Performance Tracker</h2>

                {{-- Financial Analysis --}}
                <div class="mb-5">
                    <div class="flex items-center gap-4">
                        <span class="w-24 text-lg font-semibold">Analysis</span>
                        <div class="flex-1 h-6 border border-black rounded-full">
                            <div class="h-full bg-green-400 rounded-full" style="width: 60%;"></div>
                        </div>
                    </div>
                    <span class="ml-28 text-gray-500">60%</span>
                </div>

                {{-- Tax Compliance --}}
                <div class="mb-5">
                    <div class="flex items-center gap-4">
                        <span class="w-24 text-lg font-semibold">Tax</span>
                        <div class="flex-1 h-6 border border-black rounded-full">
                ...
                <div class="mb-5">
                    <div class="flex items-center gap-4">
                        <span class="w-24 text-lg font-semibold">Budgeting</span>
                        <div class="flex-1 h-6 border border-black rounded-full">
                ...
                <div>
                    <div class="flex items-center gap-4">
                        <span class="w-24 text-lg font-semibold">Auditing</span>
                        <div class="flex-1 h-6 border border-black rounded-full">
            ...
            <div style="width: 490px;" 
                ...
                <a href="/lesson/sociology" class="block">
                    ...
                    <img src="https://via.placeholder.com/48" alt="Professor" class="w-12 h-12 rounded-full object-cover">
                    <div>
                        <h3 class="text-xl font-bold">Placeholder</h3>
            ...
            <!-- ★★★ Third lecture – just duplicate the block above and change content ★★★ -->
                <div style="width: 490px;" 
                class="bg-white rounded-xl shadow-md overflow-hidden flex-shrink-0">
                <div class="p-6 flex flex-col h-full space-y-4">
                <a href="/lesson/sociology" class="block">
     ...
     <script>
                document.querySelectorAll("aside nav a").forEach(link => {
                    link.addEventListener("click", e => {
                        ...
                        document.querySelectorAll("aside nav a").forEach(a => a.classList.remove("bg-[#D5C34E]"));

                        link.classList.add("bg-[#D5C34E]");
